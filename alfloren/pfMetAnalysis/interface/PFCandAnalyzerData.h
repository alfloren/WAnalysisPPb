...
class TreePFCandEvent
{
 public:
  ...
  bool                   passFullTrack12_[MAXPARTICLE], passFullTrack20_[MAXPARTICLE], passFullTrack30_[MAXPARTICLE];
  Int_t                   nPFpart_, nGENpart_, njets_, nGENNeu_, nGENW_, nTRACKpart_,nMuonpart_, nPFmuon_, nGENMu_, nGMpart_, nGENWout_;
  Int_t                   pfId_[MAXPARTICLE], genPDGId_[MAXPARTICLE], traQual_[MAXPARTICLE], genMotherId_[20]; 
  Int_t                   genMotherStatus_[MAXPARTICLE], traAlgo_[MAXPARTICLE], pfTrackhits_[MAXPARTICLE], trahits_[MAXPARTICLE], genZstatus_, genZcharge_, genNbMother_[MAXPARTICLE], genStatus_[MAXPARTICLE], traCharge_[MAXPARTICLE];
  ...
  Float_t          pfPt_[MAXPARTICLE], genPt_[MAXPARTICLE],  jetPt_[MAXPARTICLE], pfGloMuon_[MAXPARTICLE], GMpatPt_[MAXPARTICLE];
  Float_t                 pfEta_[MAXPARTICLE], genEta_[MAXPARTICLE],  jetEta_[MAXPARTICLE], genZmass_;
  Float_t                 jetMass_[MAXJET], jetY_[MAXJET], jetPU_[MAXJET], rawPt_[MAXJET], genMupx_[MAXPARTICLE], genMupy_[MAXPARTICLE];
   Float_t                 pfPhi_[MAXPARTICLE], genPhi_[MAXPARTICLE],  jetPhi_[MAXPARTICLE], genZPt_, genZEta_, genZPhi_, genZrapidity_;
...
class PFCandAnalyzerData : public edm::EDAnalyzer {
  public:
    explicit PFCandAnalyzerData(const edm::ParameterSet&);
    ~PFCandAnalyzerData();
